...
(custom-set-variables
 ...
 '(gnus-article-mode-hook nil)
 '(gnus-article-mode-line-format "Oort Gnus %p %5,20S")
 '(gnus-body-boundary-delimiter "_")
 '(gnus-boring-article-headers (quote (empty newsgroups long-to many-to)))
 ...
 '(gnus-group-icon-list
   (quote
    (((and mailp
	   (> unread 0))
      . "/home/dan/Multimedia/Icons/icon_mini_exclamation.gif"))))
 '(gnus-group-line-format "%m%S%p%P%E%5y/%i: %-40,40G
")
...
http://lists.gnu.org/mailman/listinfo/emacs-orgmode")))))
 '(gnus-personalities
   (quote
    (("default" "Dan Griswold <dgriswol@rochester.rr.com>" "" "/home/dan/.signature")
     ("formal" "Daniel Griswold <dgriswol@rochester.rr.com>" "" "/home/dan/.signature.formal"))))
 '(gnus-personality-electric-headers (quote ((group ".*rca" "formal"))))
 '(gnus-post-method (quote (nntp "news-server.rochester.rr.com")))
 '(gnus-read-active-file t)
 '(gnus-registry-ignored-groups (quote (("nntp" t) ("nnrss" t) ("spam" t) ("train" t))))
 '(gnus-registry-install t)
 '(gnus-registry-max-entries 2500)
 '(gnus-registry-unfollowed-groups (quote ("nnmairix")))
 ...
 '(gnus-summary-goto-unread (quote never))
 '(gnus-summary-prepared-hook nil)
 ...
 '(gnus-topic-line-format "%i%0{ %(%n%): %A %v%}
")
 '(gnus-treat-body-boundary (quote head))
 '(gnus-treat-buttonize t)
 '(gnus-treat-fill-article t)
 '(gnus-treat-fill-long-lines (quote head))
